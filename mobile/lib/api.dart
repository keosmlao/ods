  ...
  static Future<Map<String, dynamic>> _send(
    ...
    if (response.statusCode >= 400) {
      ...
      */
       ...
       *
       * 5xx ກໍ່ຄືກັນ (ແກ້ 31-08-2026): route ທີ່ throw ອອກມາດິບໆ ຕອບ **500 body ຫວ່າງ**
       * ⇒ ບໍ່ມີຊ່ອງ `error` ⇒ ແຕ່ກ່ອນຕົກມາໃຊ້ຄຳ "ເຊື່ອມຕໍ່ບໍ່ໄດ້" ທັງທີ່ຕິດຕໍ່ server
       * ໄດ້ດີ (ວັດຈິງ: check-in ບຳລຸງຮັກສາລົ້ມຢູ່ຖານ ແຕ່ຊ່າງອ່ານວ່າ "ບໍ່ມີເນັດ" ຫຼາຍມື້).
       * ບໍ່ມີສັນຍານແທ້ຈະບໍ່ມາຮອດບ່ອນນີ້ເລີຍ — ຖືກຈັບເປັນ status 0/408 ຂ້າງເທິງແລ້ວ.
       */
      throw ApiError(
        (decoded['error'] as String?) ??
            (response.statusCode == 404
                ...
                : response.statusCode >= 500
                    ? 'server ຜິດພາດ (HTTP ${response.statusCode}) — ບໍ່ແມ່ນເລື່ອງສັນຍານ, ກະລຸນາແຈ້ງຝ່າຍ IT'
                    : 'ຄຳຂໍບໍ່ຜ່ານ (HTTP ${response.statusCode})'),
        response.statusCode,
      );
    }
    return decoded;
