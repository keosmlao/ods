...
## 5. ໝວດ "ງານເຄລມ" (Claims Module)

- **ຮັບເຄລມ (`/claims/new`)**: ກວດປະກັນ (Warranty Check) ຈາກ Serial No ➔ ຖ້າຢູ່ໃນປະກັນ ສ້າງ Job Claim.
- **ປະສານ Vendor / ໂຮງງານ (`/claims/vendor`)**: ສົ່ງອຸປະກອນ/ອາໄຫຼ່ໄປເຄລມ ➔ ຕິດຕາມ Tracking ເຄລມ.
- **ປ່ຽນອາໄຫຼ່ເຄລມ & ປິດເຄລມ (`/claims/close`)**: ຮັບອາໄຫຼ່ເຄລມຈາກ Vendor ➔ ປ່ຽນໃຫ້ລູກຄ້າ ➔ ປິດເຄລມ.
