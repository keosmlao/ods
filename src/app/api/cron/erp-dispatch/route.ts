...
/**
 * ⚠️ **ບໍ່ຈຳເປັນຕ້ອງຕັ້ງແລ້ວ (06-08-2026) — ເຫຼືອໄວ້ເປັນຕົວສຳຮອງ/ຍິງດ້ວຍມືເທົ່ານັ້ນ.**
 *
 * ດຽວນີ້ການດຶງຂອງຈາກ ERP ເກີດຂຶ້ນເອງ 3 ທາງ ໂດຍບໍ່ຕ້ອງມີ scheduler ພາຍນອກ:
 *   ① ເປີດໜ້າຄິວອາໄຫຼ່ (ສາງເບີກ · ຮັບອາໄຫຼ່ · ຮັບຄືນ) ⇒ `syncErpOnView()` — 1 ຮອບ/ນາທີ
 *   ② tab ຄິວທີ່ເປີດຄ້າງໄວ້ ⇒ ErpDispatchWatcher ຍິງ `/api/sync/erp-dispatch` ທຸກ 15 ວິ
 *      (ຮວມ syncErpPurchase ແລ້ວ — ຄຸມ 1 ຮອບ/ນາທີ ຄືກັນ)
 *   ③ ເປີດ**ໃບງານ**ດ່ຽວ ⇒ `syncErpDispatchForJob()` ຖາມສະເພາະໃບຂໍຂອງງານນັ້ນ
 * ⇒ ຄວາມຊັກຊ້າສູງສຸດ = "ຈົນກວ່າຈະມີຄົນເປີດເບິ່ງ" (ຕອນກາງຄືນທີ່ບໍ່ມີໃຜເຮັດວຽກ).
 * ຢາກໃຫ້ **push ຫາຊ່າງທັນທີ 24 ຊົ່ວໂມງ** ໂດຍບໍ່ຕ້ອງມີໃຜເປີດຈໍ ຈຶ່ງຄ່ອຍຕັ້ງ cron ນີ້.
 *
 * **ດຶງໃບເບີກ/ໃບຮັບຄືນ/ໃບຮັບເຂົ້າສາງຈາກ ERP ແບບເປັນຮອບ** — ຍິງຈາກ cron ພາຍນອກ (ທຸກ 5 ນາທີ):
 *
