...
/** ປະເພດວຽກຂອງໃບ — ic_trans.job_type ('install' = ງານຕິດຕັ້ງ, ວ່າງ = ງານສ້ອມແປງ) */
const JOB_OPTIONS = [
...
export function ReceiveFilters({ q, job, tab, sort, dir }: { q: string; job: string; tab: string; sort: string; dir: string }) {
    ...
    <form ref={formRef} className="flex flex-1 flex-wrap items-center gap-2">
      ...
      <div className="flex h-9 min-w-56 flex-1 items-center gap-2 rounded-lg border border-slate-300 px-2.5">
        ...
        <input
          name="q"
          defaultValue={q}
          placeholder="ຄົ້ນຫາ ເລກທີ, ໃບອ້າງອີງ, ໝາຍເຫດ..."
