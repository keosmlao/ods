...
/**
 * "ລໍຖ້າມາແລ້ວ" ນັບຈາກເວລາອະນຸມັດພາຍໃນ.
 *
 * ⚠ ic_trans.aprove_date1 ເປັນຊະນິດ `time` (ມີແຕ່ໂມງ ບໍ່ມີວັນທີ) — ເອົາໄປລົບກັບເວລາປັດຈຸບັນ
 * ໂດຍກົງບໍ່ໄດ້ (ຈະໄດ້ "20645 ມື້" ແລະ ວັນທີ 00-00-0000). ຈຶ່ງປະກອບກັບ doc_date ເປັນ timestamp.
 */
const TIME_COL = "(a.doc_date + coalesce(a.aprove_date1, time '0:00'))";
