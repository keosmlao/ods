 ...
 *
 * ── ແທັບ "ອາໄຫຼ່ຄ້າງສາງ" **ຍ້າຍອອກແລ້ວ** (17-07-2026) ──
 * ໄປຢູ່ `/stock/spare-recovery` (ກຸ່ມສາງ) ເພາະ ① ມັນເປັນວຽກສາງ ບໍ່ແມ່ນວຽກອະນຸມັດ
 * ② ໜ້ານີ້ເປີດໄດ້ແຕ່ຜູ້ຈັດການ/ຫົວໜ້າຊ່າງ (APPROVER_SIDE) ⇒ **ຄົນສາງທີ່ຕ້ອງໄປເອົາຂອງຄືນ
 * ເປີດບໍ່ໄດ້ເລີຍ**. ໜ້ານີ້ເຫຼືອແຕ່ວຽກອະນຸມັດຢ່າງດຽວ (ລາຍລະອຽດຍັງເຕືອນເລື່ອງອາໄຫຼ່ຄືເກົ່າ).
 */
