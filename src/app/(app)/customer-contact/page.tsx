  ...
  return (
    <RowLink href={href} className="border-b border-slate-100 hover:bg-slate-50">
      <td className="px-3 py-2.5 text-center">
        <Link href={href} className="font-semibold text-brand-800 hover:underline">
          {job.code}
        </Link>
      </td>
      ...
      <td className="px-3 py-2.5 text-center text-xs">
        {job.last_contact ? (
          ...
          <span className="rounded-full bg-brand-orange-50 px-2 py-0.5 font-semibold text-brand-orange-700">{t.notContacted}</span>
        )}
      </td>
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
      <div className="flex items-start justify-between gap-2">
        <Link href={href} className="text-base font-bold text-brand-800 hover:underline">
          {job.code}
        </Link>
        <Elapsed
          seconds={job.waiting_seconds}
