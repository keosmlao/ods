...
export const NEXT_STEP: Record<number, string> = {
  ...
  10: "ສ້ອມແປງສຳເລັດ — ກະລຸນາມາຮັບເຄື່ອງ ຫຼື ລໍຖ້າການຈັດສົ່ງ",
  11: "ສົ່ງຄືນລູກຄ້າແລ້ວ — ຂອບໃຈທີ່ໃຊ້ບໍລິການ",
};

export const STAGE_TEXT = STAGE_LABEL;

/** ຂັ້ນຕອນຫຍໍ້ 7 ຂັ້ນທີ່ລູກຄ້າເຫັນ (ບາງໃບຂ້າມຂັ້ນ ເຊັ່ນ ຍັງຮັບປະກັນ ບໍ່ຕ້ອງສະເໜີລາຄາ) */
export const STEPS = [
  "ຮັບເຄື່ອງເຂົ້າສ້ອມ",
  "ກວດເຊັກເຄື່ອງ",
  "ສະເໜີລາຄາ",
...
const STEP_OF_STAGE: Record<number, number> = { 1: 1, 2: 1, 3: 2, 4: 2, 5: 3, 6: 3, 7: 3, 8: 4, 9: 4, 10: 5, 11: 6 };
