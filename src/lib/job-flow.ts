...
export async function finishInstallFlow(
   ...
   *   ແອ (ລະຫັດ 12xx) = ໜ່ວຍໃນ + ໜ່ວຍນອກ ຄົນລະເລກ · ເຄື່ອງອື່ນ = 1 ໜ່ວຍ
   * (ເບິ່ງ lib/install-scan.installUnits — ຄິດຈາກລະຫັດສິນຄ້າ ບໍ່ຖາມ ERP ອີກ 08-08-2026)
   */
...
/**
 * ອາໄຫຼ່ຂອງວຽກຕ້ອງ **ຂໍເບີກ ແລະ ສາງເບີກອອກຄົບກ່ອນ** ຈຶ່ງບັນທຶກ "ສ້ອມແປງສຳເລັດ" ໄດ້.
 *
 ...
 * ທຸກສະຖານະທີ່ຕິດຢູ່ນີ້ມີໜ້າສຳລັບແກ້ສະເໝີ (ຂໍເບີກ / ສາງເບີກ)
 * ຫຼື ລຶບແຖວທີ່ບໍ່ໄດ້ໃຊ້ຈິງອອກຈາກໜ້າສ້ອມແປງ.
 *
 * ── ⚠️ ຖອນດ່ານ "ຕ້ອງກົດຮັບອາໄຫຼ່" ອອກ (13-08-2026 ຕາມຄຳສັ່ງ) ──
 * ຮຸ່ນກ່ອນຍັງກັ້ນຢູ່ແຖວທີ່ **ຂໍແລ້ວ · ສາງເບີກອອກແລ້ວ ແຕ່ຊ່າງຍັງບໍ່ກົດຮັບ (PISP)**
 * ⇒ ຈໍຂຶ້ນ "ຍັງມີອາໄຫຼ່ n ລາຍການທີ່ຍັງບໍ່ໄດ້ກົດຮັບ" ຕອນຈະບັນທຶກສ້ອມສຳເລັດ ທັງທີ່ຂອງ
 * ມາຮອດມືຊ່າງແລ້ວ (ຫ້ອງສ້ອມຢູ່ສູນບ່ອນດຽວກັບສາງ). **ຊ່າງສ້ອມບໍ່ຈຳເປັນຕ້ອງກົດຮັບ**
 * ⇒ ດຽວນີ້ຖືວ່າ ສາງເບີກອອກ = ຮັບແລ້ວ (lib/erp-dispatch stamp `pick_finish` ໃຫ້ເອງ)
 * ແລະ ດ່ານນີ້ບໍ່ນັບຂັ້ນ "ກົດຮັບ" ອີກ — ໃບເກົ່າທີ່ເບີກໄປກ່ອນໜ້ານີ້ຈຶ່ງບໍ່ຄ້າງນຳ.
 * ບັນຊີສາງຍັງຄົບຄືເກົ່າ: ດ່ານ ① ບໍ່ມີໃບຂໍ ແລະ ② ສາງຍັງບໍ່ເບີກ ຍັງຢູ່.
 * (ຝັ່ງຕິດຕັ້ງບໍ່ກ່ຽວ — ຍັງຕ້ອງກົດຮັບທຸກໃບ ຜ່ານ lib/install-spare-gate.)
 */
async function pendingSpareBlocker(code: string): Promise<string | null> {
  ...
  if (row.not_requested)
    return `ຍັງມີອາໄຫຼ່ ${row.not_requested} ລາຍການທີ່ບໍ່ໄດ້ສ້າງໃບຂໍເບີກ — ຕ້ອງຂໍເບີກ ແລະ ໃຫ້ສາງເບີກອອກກ່ອນ ຈຶ່ງບັນທຶກສ້ອມແປງສຳເລັດໄດ້ (ຖ້າບໍ່ໄດ້ໃຊ້ຈິງ ໃຫ້ລຶບອອກຈາກລາຍການ)`;
  if (row.not_issued)
    return `ສາງຍັງບໍ່ທັນເບີກອາໄຫຼ່ອອກໃຫ້ ${row.not_issued} ລາຍການ — ລໍຖ້າສາງເບີກອອກກ່ອນ ຈຶ່ງບັນທຶກສ້ອມແປງສຳເລັດໄດ້`;
  // ຂໍແລ້ວ · ສາງເບີກອອກແລ້ວ ⇒ **ຜ່ານ** (ບໍ່ຖາມຫາໃບ PISP ອີກ — ເບິ່ງໝາຍເຫດຂ້າງເທິງ)
  return null;
}
