...
const RULES: Rule[] = [
  ...
  /**
   * ຖອນຄືນຂັ້ນກວດເຊັກ (ບໍ່ແມ່ນໜ້າ — ເປັນ **ສິດ** ຄຸມປຸ່ມ "ຍົກເລີກເລີ່ມກວດເຊັກ" ແລະ
   * "ຍົກເລີກສຳເລັດການກວດເຊັກ" ຢູ່ຄິວງານ ແລະ ຟອມກວດເຊັກ).
   * ຄ່າຕັ້ງຕົ້ນຄືກັບ `/checking` — ຢາກໃຫ້ CS ຄົນໃດຄົນນຶ່ງຍ້ອນຂັ້ນຄືນໄດ້
   * ໃຫ້ຜູ້ຈັດການຕິກ "ແກ້ໄຂ" ຂອງລາຍການ "ຍ້ອນຂັ້ນກວດເຊັກຄືນ" ທີ່ /manage/employees
   * (ສິດລາຍຄົນຊະນະ role) — ບໍ່ຕ້ອງເປີດ `/checking` ໃຫ້ທັງ role.
   */
  { path: "/checking/undo", roles: TECH_SIDE },
  ...
  { path: "/manage/push-recipients", roles: APPROVER_SIDE },
