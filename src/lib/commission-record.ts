 ...
 *
 * ── ⚠️ ເປັນຫຍັງບໍ່ຢູ່ໃນ actions/ ອີກ ──
 * ເມື່ອກ່ອນຢູ່ໄຟລ໌ `"use server"` ⇒ ເປັນ **endpoint ສາທາລະນະທີ່ບໍ່ມີດ່ານກວດ**:
 * ຄົນນອກຍິງໃຫ້ຄິດຄ່າຄອມຂອງງານໃດກໍ່ໄດ້. ມັນຖືກເອີ້ນຈາກ action ທີ່ກວດສິດແລ້ວ
 * ຕອນປິດງານເທົ່ານັ້ນ ⇒ ຢູ່ນີ້ບໍ່ມີ endpoint ໃຫ້ຍິງອີກ.
 *
 * ── ຫ້າມພັງ ──
