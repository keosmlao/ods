...
export const ERP = {
  ...
  /**
   * ສາຂາຂອງໃບ**ຂໍ**ເບີກ/ຂໍສົ່ງຄືນ — **ສາຂາຂົວຫຼວງ (01) ສະເໝີ** ບໍ່ອີງສາງ.
   * branchOf() ຈັບຄູ່ 1204→00 (ສຳນັກງານໃຫ່ຍ) ຕາມ ods ເກົ່າ ⇒ ໃບຂອງສາງດອນຕີ້ວ
   * ອອກເປັນສາຂາຜິດ (SION2026072399) — ສູນບໍລິການສັງກັດສາຂາຂົວຫຼວງ.
   */
  BRANCH_REQUEST: "01",
