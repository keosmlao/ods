...
/**
 * **ອາໄຫຼ່ທີ່ເບີກອອກໄປແລ້ວ ແຕ່ວຽກຖືກຍົກເລີກ ⇒ ຍັງບໍ່ໄດ້ເອົາຄືນສາງ** — ນິຍາມບ່ອນດຽວ.
 *
 * ⚠️ ຊື່ເກົ່າ "ອາໄຫຼ່ຄ້າງສາງ" **ຂຽນຜິດຄວາມໝາຍ** (ອ່ານແລ້ວນຶກວ່າຂອງຢູ່ໃນສາງ) —
 * ຄວາມຈິງຂອງ **ຢູ່ນອກສາງ**: ຢູ່ກັບຊ່າງ ຫຼື ໃສ່ຢູ່ໃນເຄື່ອງທີ່ຍົກເລີກ ແລະ ຕ້ອງເກັບຄືນ
 * ບໍ່ດັ່ງນັ້ນສະຕັອກໃນລະບົບໜ້ອຍກວ່າຂອງຈິງ. ດຽວນີ້ໃຊ້ຊື່ "ອາໄຫຼ່ຄ້າງນອກສາງ" ທຸກບ່ອນ.
 *
 * ໃຊ້ຢູ່ 2 ໜ້າ: /stock/spare-recovery (ວຽກຂອງສາງ) ແລະ ໜ້າລາຍລະອຽດການຍົກເລີກ.
 *
