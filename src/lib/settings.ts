...
export const SETTING = {
  ...
  /** ເບີກອາໄຫຼ່ຕິດຕັ້ງ **ນອກມາດຕະຖານ** — ຄົ້ນ ERP ເພີ່ມລາຍການເອງໃນໃບຂໍເບີກ */
...
export const SETTING_META: Record<SettingKey, { label: string; help: string; fallback: boolean }> = {
  ...
  [SETTING.INSTALL_SPARE_FREE_SEARCH]: {
    label: "ເບີກອາໄຫຼ່ຕິດຕັ້ງ ນອກມາດຕະຖານ (ຄົ້ນ ERP ເພີ່ມເອງ)",
    help:
      "ໃຫ້ຊ່າງຄົ້ນ ERP ແລ້ວເພີ່ມອາໄຫຼ່ທີ່ **ບໍ່ຢູ່ໃນຊຸດຕິດຕັ້ງ** (used_spare_install ຕາມຂະໜາດ BTU) " +
      "ແລະ ບໍ່ຢູ່ໃນກະຕ່າຂອງງານ. ຂໍ້ມູນຈິງ 2 ປີ: ແຖວທີ່ຊ່າງເບີກ **69% ຢູ່ໃນຊຸດ** ⇒ ປິດແລ້ວ 31% " +
      "(~2,000 ແຖວ/2 ປີ — ສ່ວນຫຼາຍທໍ່/ຂາເຫລັກທີ່ໜ້າງານຕ້ອງການເພີ່ມ) ຈະຖືກຫ້າມ.",
    // ເປີດເປັນຄ່າຕັ້ງຕົ້ນ — ປິດແລ້ວຊ່າງເພີ່ມລາຍການນອກຊຸດບໍ່ໄດ້
    fallback: true,
  },
  [SETTING.MOBILE_FORCE_UPDATE]: {
    label: "ບັງຄັບແອັບຊ່າງອັບເດດເປັນເວີຊັນຫຼ້າສຸດ",
    help:
      "ແອັບທີ່ເກົ່າກວ່າ APK ທີ່ວາງຢູ່ໜ້າ /download ຈະໃຊ້ງານບໍ່ໄດ້ຈົນກວ່າຈະອັບເດດ " +
      "(server ຕອບ 426 ທຸກຄຳຂໍຂອງມືຖື ⇒ ແອັບຂຶ້ນໜ້າ “ຕ້ອງອັບເດດ” ພ້ອມປຸ່ມໂຫຼດ+ຕິດຕັ້ງໃນຕົວ). " +
      "ເວີຊັນຂັ້ນຕ່ຳ **ຂະຫຍັບເອງ** ຕາມ APK ທີ່ວາງ (public/downloads/ods.apk.version) ບໍ່ຕ້ອງພິມເລກ. " +
      "ບໍ່ມີໄຟລ໌ເວີຊັນ = ບໍ່ບັງຄັບໃຜ (ບໍ່ລັອກຊ່າງອອກເພາະໄຟລ໌ຫາຍ). ປິດແລ້ວ: ແອັບເກົ່າຍັງໃຊ້ໄດ້ຕໍ່ " +
