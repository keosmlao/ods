...
export const SETTING_META: Record<SettingKey, { label: string; help: string; fallback: boolean }> = {
  ...
  [SETTING.INSTALL_SPARE_FREE_SEARCH]: {
    ...
    help:
      "ໃຫ້ຊ່າງ “ຄົ້ນຫາຈາກ ERP” ແລ້ວເພີ່ມອາໄຫຼ່ທີ່ **ບໍ່ຢູ່ໃນລາຍການມາດຕະຖານ ແລະ ບໍ່ຢູ່ໃນກະຕ່າ** ເຂົ້າໃບຂໍເບີກ. " +
      "ປິດແລ້ວ: ຊ່ອງຄົ້ນຫາຫາຍ ແລະ ຝັ່ງ server ປະຕິເສດລາຍການໃໝ່ (ຍິງ action ໂດຍກົງກໍ່ບໍ່ໄດ້) — " +
      "ເລືອກໄດ້ແຕ່ລາຍການມາດຕະຖານ ຫຼື ລາຍການທີ່ມີໃນກະຕ່າຢູ່ແລ້ວ. " +
      "⚠️ ຂໍ້ມູນຈິງ: “ມາດຕະຖານ” ດຽວນີ້ອ່ານຈາກຊຸດຂອງສິນຄ້າໃນ ERP (ic_inventory_set_detail) ເຊິ່ງເປັນ " +
      "ອົງປະກອບຂອງຕົວເຄື່ອງເອງ (ໜ່ວຍໃນ/ໜ່ວຍນອກ/ກ່ອງທໍ່) ບໍ່ແມ່ນອາໄຫຼ່ຕິດຕັ້ງ — 1 ປີຫຼັງສຸດ ແຖວອາໄຫຼ່ໃນກະຕ່າ " +
      "0 ຈາກ 1,971 ແຖວທີ່ຢູ່ໃນຊຸດ ⇒ ປິດສະວິດນີ້ດຽວນີ້ = ງານໃໝ່ເກືອບທຸກງານເພີ່ມອາໄຫຼ່ບໍ່ໄດ້ເລີຍ. " +
      "ໃຫ້ນິຍາມລາຍການມາດຕະຖານກ່ອນຈຶ່ງປິດ.",
    // ຄ່າຕັ້ງຕົ້ນ = ເປີດ (ພຶດຕິກຳເກົ່າ) — ປິດແລ້ວຄວາມສາມາດຫາຍໄປສຳລັບທຸກຄົນ
    fallback: true,
  },
};
