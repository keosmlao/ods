...
export const SETTING_META: Record<SettingKey, { label: string; help: string; fallback: boolean }> = {
  ...
  [SETTING.INSTALL_SPARE_FREE_SEARCH]: {
    ...
    help:
      "ໃຫ້ຊ່າງຄົ້ນ ERP ແລ້ວເພີ່ມອາໄຫຼ່ທີ່ບໍ່ຢູ່ໃນ **ຊຸດຂອງສິນຄ້າ (ic_inventory_set_detail)** ແລະ " +
      "ບໍ່ຢູ່ໃນກະຕ່າຂອງງານ. ⚠️ ຂໍ້ມູນຈິງ 2 ປີ: ແຖວອາໄຫຼ່ຂອງງານແອ 6,498 ແຖວ **ບໍ່ມີອັນໃດຢູ່ໃນຊຸດ** " +
      "(ຊຸດຄືອົງປະກອບຂອງຕົວເຄື່ອງ ບໍ່ແມ່ນອາໄຫຼ່ຕິດຕັ້ງ) ⇒ ປິດດຽວນີ້ = ຊ່າງເບີກບໍ່ໄດ້ເລີຍ.",
    // ເປີດເປັນຄ່າຕັ້ງຕົ້ນ — ປິດແລ້ວຢຸດການເບີກທັງໝົດ (ເບິ່ງເຫດຜົນຂ້າງເທິງ)
    fallback: true,
  },
};
