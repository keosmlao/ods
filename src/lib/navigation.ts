...
const REPORT: NavGroup = {
  ...
  items: [
    ...
    // ລາຍໃບ: ໃບໃດຊ້າ/ຜິດຂັ້ນຕອນ ທຽບ SLA · ໃຜຮັບຜິດຊອບ · ບ່ອນກອກສາເຫດ (ຄູ່ກັບ KPI ຂ້າງເທິງ)
    { label: "ກວດສອບງານສ້ອມແປງ", href: "/reports/repair-audit" },
...
const RECEIPT: NavGroup = {
  ...
  icon: ReceiptText,
  items: [
    { label: "ບິນຂາຍງານສ້ອມແປງ", href: "/receipts" },
    ...
    // ສະຫຼຸບໜ້າດຽວ: ຕິດຕັ້ງ/ສ້ອມ × ແອ/ເຄື່ອງໃຊ້ໄຟຟ້າ ຕາມເດືອນ
    { label: "ສະຫຼຸບລາຍຮັບປະຈຳເດືອນ", href: "/revenue-summary" },
  ],
};
