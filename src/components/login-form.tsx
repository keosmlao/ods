...
export function LoginForm() {
  ...
  return <form action={action} className="space-y-5">
    ...
    <label className="block"><span className="mb-2 block text-sm font-medium text-slate-600">ລະຫັດພະນັກງານ</span><span className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100"><User className="size-5 text-slate-400"/><input name="username" required autoComplete="username" className="h-12 w-full outline-none" placeholder="ປ້ອນລະຫັດພະນັກງານ"/></span><span className="mt-1.5 block text-xs text-slate-400">ໃຊ້ຊື່ຫຼິ້ນ ຫຼື ຊື່ເຕັມ ແທນກໍ່ໄດ້</span></label>
