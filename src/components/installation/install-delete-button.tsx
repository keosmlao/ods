...
/**
 * ລຶບງານຕິດຕັ້ງ — **ຜູ້ຈັດການເທົ່ານັ້ນ ແລະ ຍ້ອນຄືນບໍ່ໄດ້** (ຄູ່ກັບປຸ່ມລຶບໃບຮັບເຄື່ອງ).
 *
 * ບອກຄວາມຈິງໃຫ້ຄົນກົດຮູ້ກ່ອນ: ເອກະສານເບີກອາໄຫຼ່ຖືກລຶບຕາມ ແລະ **ສະຕັອກ ERP ບໍ່ຄືນ**.
 * ບັງຄັບໃສ່ເຫດຜົນ — ເກັບເປັນຫຼັກຖານໃສ່ chatter ຂອງລູກຄ້າ (ເບິ່ງ actions/install-delete.ts).
 */
export function InstallDeleteButton({ code }: { code: string }) {
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <Button
                ...
                onClick={() =>
                  start(async () => {
                    const result = await deleteInstall(code, reason);
                    if (result.error) {
